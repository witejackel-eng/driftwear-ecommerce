...
export const products: Product[] = [
  ...
  },
  {
    ...
    colors: [
      {
        name: 'Washed Black',
        hex: '#333333',
        image: '/images/products/men-graphic-tee.jpg',
        hoverImage: '/images/products/men-graphic-tee-2.jpg',
      },
      {
        name: 'Faded Teal',
        hex: '#5F9EA0',
    ...
    images: [
      '/images/products/men-graphic-tee.jpg',
      '/images/products/men-graphic-tee-2.jpg',
    ],
    rating: 0,
    reviewCount: 0,
    isNew: true,
...
export function filterProducts(
  ...
  switch (filters.sortBy) {
    ...
    case 'price-desc':
      ...
      break;
    case 'rating':
      // No genuine ratings — sort by best-seller flag then price
      filtered.sort((a, b) => {
